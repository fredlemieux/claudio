/**
 * Claudio Icon Library
 *
 * All SVG icons in one place. Each icon accepts a className prop for sizing/color.
 * Uses `fill="currentColor"` so color is controlled by parent text color classes.
 *
 * Usage:
 *   import { IconSearch, IconClose } from "../icons";
 *   <IconSearch className="w-4 h-4 text-text-secondary" />
 */
...
export function IconCloseSmall({ className }: IconProps) {
  return (
...
export function IconCodeBrackets({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
